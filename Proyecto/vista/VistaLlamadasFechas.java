...
public class VistaLlamadasFechas implements Vista, Serializable{
	...
	public VistaLlamadasFechas(JFrame padre) {
		ventana = new JDialog(padre, "Llamadas de un cliente entre dos fechas", true);
	...
	public void listarLlamadasFechas(Collection<Llamada> llamadas) {
		emergente = new JDialog(ventana, true);
		JPanel general = new JPanel();
			
		StringBuilder cadena = new StringBuilder();
		cadena.append("Llamadas:\n\n");
		for(Llamada llamada : llamadas) {
			cadena.append(llamada);
		}
	...
	private class Aceptar implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				controlador.showLlamadasClienteFechas((VistaLlamadasFechas) getVista());
	...
	public void resultadoNo(){
		...
		lMensaje = new JLabel("No existen llamadas entre esas fechas.");
